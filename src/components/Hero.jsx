    ...
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            Hi, I'm Sneha S <br /> <span className="text-white">Full Stack Engineer</span>
          </h1>
          ...
          >
            {/* Primary Button */}
            <a href="#projects" className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full bg-white text-black font-semibold hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 shadow-md inline-block">
              View My Work
            </a>
        ...
        {/* Right Side: Play Video Button - Hidden on Mobile */}
        {!isMobile && (
          <div
            data-aos="zoom-in"
            data-aos-delay="600"
        ...
        {isMobile && (
          <div
            className="absolute bottom-8 right-6 flex flex-col items-center gap-2 cursor-pointer group z-30"
            onClick={toggleVideo}
          >
            <div className="w-14 h-14 rounded-full border border-white/30 bg-black/20 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#ff2a2a] transition-all duration-500 shadow-[0_0_30px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_40px_rgba(255,42,42,0.6)]">
              {!isPlaying || isMuted ? (
            ...
            <span className="text-white text-[10px] font-bold tracking-widest uppercase opacity-70 group-hover:opacity-100 transition-opacity">
